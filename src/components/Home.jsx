    ...
    <div>
      <Carousel data-bs-theme="dark" interval={null} controls={true} indicators={true}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl my-10">Our Mission</h1>
            <p className="text-xl sm:text-2xl text-white my-20 max-w-3xl mx-auto">
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl my-10">What We Do</h1>
            <p className="text-xl sm:text-2xl text-white my-20 max-w-3xl mx-auto">
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl my-10">Join Us</h1>
            <p className="text-xl sm:text-2xl text-white my-20 max-w-3xl mx-auto">
      ...
      <div className="bg-red-50 py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center border-2 border-red-700 p-6 shadow-md">
      ...
      {[
        ...
        <div className="bg-red-50 mx-10 p-6 my-8 border-2 rounded-2xl shadow-md" key={index}>
          <div className="mb-4 cursor-pointer" onClick={() => toggleDetails(index)}>
            <div className="flex items-center">
              <span className="text-2xl font-semibold">{step.title}</span>
              <span
                className={`ml-2 transform transition-transform ${openSteps[index] ? "rotate-180" : ""}`}
              >
          ...
          {openSteps[index] && (
            <div className="flex flex-col md:flex-row items-start">
              <img src={step.image} alt={step.title} className="w-full md:w-64 mb-4 md:mr-4 " />
              <ul className="list-disc text-lg my-16">
